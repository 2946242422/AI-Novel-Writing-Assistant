  ...
  management: {
    ...
    advancedTemplate: {
      ...
      requiredContextGroups: [
        ...
        "craft_plan", "character_hard_facts", "obligation_contract", "volume_window",
  ...
  render: (input, context) => {
    ...
    return [
      ...
      "4a. 角色行为指导中的主观倾向、以及作者与角色对话后确认的软性行为倾向，都只用于塑造角色的选择、误判和情绪反应，不是客观真相或强制剧情命令；不得把角色的猜测、误判、隐藏意图或对话影响写成旁白确认的事实，也不得覆盖 character_hard_facts。",
        ...
        "6. 执行 craft_plan 时以自然、准确和有效为先：禁止把技法名称写进正文，禁止为了完成技法而堆叠比喻、强行通感、罗列感官或让人物用对白解释背景。",
        "",
        "【风格与续写约束】",
        ...
        "(5) craft_plan 是否只在目标场景服务了预定目的，并避开了其中列出的表达与逻辑风险？",
